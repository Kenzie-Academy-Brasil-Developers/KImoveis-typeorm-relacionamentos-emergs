...
export class createTable1666897389852 implements MigrationInterface {
    name = 'createTable1666897389852'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schedule_user_properties" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "hour" TIME NOT NULL, "propertyId" uuid, "userId" uuid, CONSTRAINT "PK_92b9b746e8fba52f49d346fa835" PRIMARY KEY ("id"))`);
